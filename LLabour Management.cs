...
{
    public partial class LLabour_Management : Form
    {
        public LLabour_Management()
        {
            InitializeComponent();
        }
        ...
        {
            if (txtlabcnic.Text != "" && txtlabname.Text != "" && txtlabaddress.Text != "" && txtlabphone.Text != "" && txtlabpaidsalary.Text != "")
            {

                var st = new ManagementLLabour
                {
                    ...
                    LabourPaidSalary = double.Parse(txtlabpaidsalary.Text),

                };
                db.ManagementLLabours.InsertOnSubmit(st);
                db.SubmitChanges();
        ...
        {
            var st = from s in db.ManagementLLabours select s;
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtlabpaidsalary.Text = dataGridView1.SelectedRows[0].Cells[4].Value.ToString();
        }
        ...
        private void bttn4_Click(object sender, EventArgs e)
        {
            if (txtlabcnic.Text != "" && txtlabname.Text != "" && txtlabaddress.Text != "" && txtlabphone.Text != "" && txtlabpaidsalary.Text != "")
            {
                ...
                var st = (from s in db.ManagementLLabours where s.LabourCNIC == double.Parse(txtlabcnic.Text) select s).First();
                db.ManagementLLabours.DeleteOnSubmit(st);
                db.SubmitChanges();
        ...
        private void LLabour_Management_Load(object sender, EventArgs e)
        {
            var st = from s in db.ManagementLLabours select s;
            dataGridView1.DataSource = st;
        }
